...
ofile=basepath+'/prepostmatchedpairst.nii.gz'
...
groupnetwork(prefiles,basepath+'/pregroupnetwork.nii.gz')
groupnetwork(postfiles,basepath+'/postgroupnetwork.nii.gz')
