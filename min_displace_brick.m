...
% add path to dependencies to matlab path
addpath('/home/mkayvanrad/code/oppni/oppni-latest/scripts_matlab');
addpath('/home/mkayvanrad/code/utils/NIfTI_20140122');
