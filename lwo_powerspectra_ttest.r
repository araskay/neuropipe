csvfile <- '/home/mkayvanrad/data/healthyvolunteer/processed/lowPowerSpectra.csv'

data <- read.csv(csvfile)

print(t.test(data$NetlowRelativePowerPre,data$NetlowRelativePowerPost,paired=TRUE))
