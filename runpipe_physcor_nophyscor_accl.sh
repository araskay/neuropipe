...
python pipe.py --subjects ~/data/healthyvolunteer/fepi_subjects_physcor_checked_physio_skullstrip_reorient_connseedcordinates_aseg_registrations_connseed.txt --pipeline ~/data/healthyvolunteer/processed/pipe_physcor_const_withmotreg.txt --template $MNI152 --meants --seedconn --resout ~/data/healthyvolunteer/processed/physcor/pipe_physcor_nophyscor_withmotreg --runpipename nophyscor_withmotreg --keepintermed
