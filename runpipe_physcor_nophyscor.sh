...
#SBATCH --mem=64000
#SBATCH -t 72:0:0
#SBATCH -o runpipe_physcor_nophyscor.o
#SBATCH -e runpipe_physcor_nophyscor.e
...
python pipe.py --subjects ~/data/healthyvolunteer/fepi_subjects_physcor_checked_physio_skullstrip_reorient_connseedcordinates_aseg_registrations_connseed.txt --fixed ~/data/healthyvolunteer/processed/pipe_physcor_const_withmotreg.txt --template $MNI152 --meants --seedconn --resout ~/data/healthyvolunteer/processed/physcor/pipe_physcor_nophyscor_withmotreg --fixpipename nophyscor_withmotreg --keepintermed
